...
//                 description={visibleSection=="about"?
...
const Instamart = () => {
    const [visibleSection, setVisibleSection] = useState(null); // Initialize to null

    const toggleSection = (sectionName) => {
        if (visibleSection === sectionName) {
            setVisibleSection(null); // Toggle off if already visible
        } else {
            setVisibleSection(sectionName); // Toggle on if not visible
        }
    };
